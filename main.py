...
# ═══════ CARD LOG SCREEN ═══════════════════════════════════════════════════════
def card_log_screen(acquired,player):
    ...
    while True:
        ...
        for ev in pygame.event.get():
            ...
            if ev.type==pygame.KEYDOWN:
                ...
                if ev.key==pygame.K_i: index_screen(save)
    ...
    while True:
        ...
        for ev in pygame.event.get():
            ...
            if ev.type==pygame.KEYDOWN:
                ...
                if ev.key==pygame.K_m: meta_upgrade_screen(save)
                if ev.key==pygame.K_i: index_screen(save)
...
# ═══════ DEATH SCREEN ══════════════════════════════════════════════════════════
def death_screen(save,wave,level,kills,boss_kills,score,weapon_name):
    ...
    while True:
        ...
        for ev in pygame.event.get():
            ...
            if ev.type==pygame.KEYDOWN:
                ...
                if ev.key==pygame.K_m: meta_upgrade_screen(save); return "menu"

# ═══════ GAME LOOP ═════════════════════════════════════════════════════════════
def game_loop(starting_weapon,save):
        ...
        for ev in pygame.event.get():
            ...
            if ev.type==pygame.KEYDOWN:
                ...
                if state=="upgrade":
                    ...
                    if ev.key==pygame.K_TAB: card_log_screen(acquired,player)
                if state=="dead":
                    if ev.key in (pygame.K_r,pygame.K_m):
                        result=death_screen(save,wm.wave,player.level,kills,boss_kills,score,starting_weapon)
                        if result=="restart": game_loop(starting_weapon,save); return
                        else: sw=weapon_select_screen(save); game_loop(sw,save); return
                if state=="play":
                    ...
                    if ev.key==pygame.K_TAB:
                        card_log_screen(acquired,player)
